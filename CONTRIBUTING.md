...
This document outlines how you can contribute to the Project Based Assessment WebApp project.

## Instructors, Faculty, and Administrators 

The Project Based Assessment WebApp allows instructors, faculty, and administrators from K-12 to universities to implement scientifically-backed measures of knowledge and difficulty when using rubric-based instruments. We believe that better measures result in better education outcomes.  Therefore, the best contribution is use and encouraging use in your school or university. Here are some ideas:

1. Create new rubrics for your discipline
2. Create new assessment procedures in your department
3. Examine how rubric-based results can be used in teaching portfolios
